            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>
                        <?php
                        if ($auth->user_type == 4) {
                            echo "Material Provider Profile Information";
                        }
                        ?>
                    </h5>
                    <div class="ibox-tools">
                        <?php echo $this->Html->link(__(''), ['controller' => 'material-provider', 'action' => 'editProfile', $gcsc->id], ['class' => 'btn btn-primary fa fa-edit']) ?>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    foreach ($userservices as $service) : ?>
                                        <div class="col-md-4">
                                            <label for=""> <?php echo ++$count . "." . $service->product->product_name ?></label>
                                        </div>
                                    <?php endforeach; ?>
                                </div>
                            </div>
