    ...
    <div class="row border-bottom">
        <nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <form role="search" class="navbar-form-custom" action="/admin/users/dashboard">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                        <i class="fa fa-bell"></i> <span class="label label-primary"><?php echo $notifications->count();  ?></span>
                    </a>
                    <ul class="dropdown-menu dropdown-alerts">
                        ...
                        ?>
                            <li>
                                <a href="/admin/users/readNotification/<?= $notify->id ?>">
                                    <div>
