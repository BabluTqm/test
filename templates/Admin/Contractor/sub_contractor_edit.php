    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5>Update Sub Contractor Details </h5>
          <div class="ibox-tools">
            <?php echo $this->Html->link(__('Back'), ['controller' => 'Contractor', 'prefix' => 'Admin', 'action' => 'subListing'], ['class' => 'btn btn-success']); ?>
            <input type="hidden" id="sc" value="<?php echo $user->user_type ?>">
          </div>
        </div>
        <div class="ibox-content">
          <?php echo $this->Form->create($user, ['id' => 'sc-form']); ?>
          <div class="row">
